...
在‘我的’一栏中，点击头像可以修改自己的个人信息。同时可以展示自己发布的帖子或者收藏的帖子。

![我的](10/‘’我的‘’栏.png)
![修改](10/修改.png)

首页会展示所有的帖子，对应分区展示对应的帖子。
...
发布界面，在输入标题以及正文之后，可以选择添加图片，图片用户可以选择拍摄或者打开相册进行挑选。

![发布1](10/发布-1.png)
![发布2](10/发布-2.png)

消息界面，点击对应的一栏进入对应的私聊界面，在底部输入框中输入点击发送可以发送信息。
...
所以下一步的方向是精简项目，将一些可以共用的内容进行封装，减少代码的冗余。
