...
|---|---|---|---|---|
|body|body|object|false|none|
|» followed|body|string|true|被关注者|
|» following|body|string|true|关注者|
|» token|body|string|true|关注者token|
...
|» followed|body|string|true|被关注者|
|» following|body|string|true|关注者|
|» token|body|string|true|关注者tkoen|
